      ...
      {open && (
        ...
        >
          ...
          <label className="text-sm">
            ...
            <select name="source" required defaultValue="walk_in" className="w-full rounded-lg border border-line bg-surface px-3 py-2">
          ...
          <label className="text-sm">
            ...
            <input type="date" name="followUpDate" className="w-full rounded-lg border border-line px-3 py-2" />
          </label>
          ...
          <label className="text-sm sm:col-span-2 lg:col-span-3">
            ...
            <textarea name="notes" rows={2} className="w-full rounded-lg border border-line px-3 py-2" placeholder="Anything worth remembering for the follow-up call…" />
          </label>
