...
export function AddAssetForm({ branches }: { branches: Branch[] }) {
  ...
  return (
    <div>
      ...
      {open && (
        <form ref={formRef} action={formAction} className="mt-4 grid grid-cols-1 gap-4 rounded-xl border border-slate-200 bg-white p-6 sm:grid-cols-3">
          ...
          <label className="text-sm">
            ...
            <input name="name" required placeholder="e.g. CCTV camera set" className="w-full rounded-lg border border-slate-300 px-3 py-2" />
          </label>
          <label className="text-sm">
            <span className="mb-1 block font-medium">Category *</span>
            <select name="category" className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2">
          ...
          <label className="text-sm">
            ...
            <input name="qty" type="number" min={1} defaultValue={1} className="w-full rounded-lg border border-slate-300 px-3 py-2" />
          </label>
          <label className="text-sm">
            <span className="mb-1 block font-medium">Unit Value (Rs.) *</span>
            <input name="unitValue" required inputMode="decimal" placeholder="e.g. 25,000" className="w-full rounded-lg border border-slate-300 px-3 py-2" />
          </label>
          <label className="text-sm">
            <span className="mb-1 block font-medium">Purchased On</span>
            <input name="purchasedOn" type="date" className="w-full rounded-lg border border-slate-300 px-3 py-2" />
          </label>
